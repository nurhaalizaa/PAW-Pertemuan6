...
<div class="container mt-3">
  ...
  <p>Berikut merupakan data mahasiswa dari jurusan teknik informatika fakultas  teknik : </p>
  <button type="button" class="btn btn-secondary"><a href ='form.php'>Tambah Data</a></button>            
